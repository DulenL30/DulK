      ...
      <footer className="relative bg-gradient-to-br from-green-50 to-green-100 border-t border-green-200">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-lg font-semibold text-slate-800 mb-6">Product</h4>
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Features</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Pricing</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Security</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Integrations</a></li>
              </ul>
            </div>

            {/* Support */}
            <div>
              <h4 className="text-lg font-semibold text-slate-800 mb-6">Support</h4>
              <ul className="space-y-4">
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Help Center</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Contact Us</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Privacy Policy</a></li>
                <li><a href="#" className="text-slate-600 hover:text-green-600 transition-colors duration-300">Terms of Service</a></li>
              </ul>
            </div>
          </div>
